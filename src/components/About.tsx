        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="hover:scale-105 transition-transform duration-300 ease-in-out bg-white p-6 rounded-lg shadow-lg text-center">
            <div className="flex justify-center mb-4">
              <span className="inline-block bg-blue-100 text-primary p-5 rounded-full">
                <i className="fas fa-users fa-3x text-primary"></i>
              </span>
            </div>
            <h2 className="text-2xl font-bold text-primary mb-4">Who We Are</h2>
            <p className="text-nursery leading-relaxed">
          ...
          <div className="hover:scale-105 transition-transform duration-300 ease-in-out bg-white p-6 rounded-lg shadow-lg text-center ">
            <div className="flex justify-center mb-4">
              <span className="inline-block bg-green-100 text-primary p-5 rounded-full">
          ...
          <div className="hover:scale-105 transition-transform duration-300 ease-in-out bg-white p-6 rounded-lg shadow-lg text-center ">
            <div className="flex justify-center mb-4">
              <span className="inline-block bg-yellow-100 text-primary p-5 rounded-full">
